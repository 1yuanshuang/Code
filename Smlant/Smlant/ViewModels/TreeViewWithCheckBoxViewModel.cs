...
{
    public class TreeViewWithCheckBoxViewModel : ViewModelBase
    {
        ...
        public TreeViewWithCheckBoxViewModel()
        {
        ...
        {
            DataSource = DataFactory.GetAllTypeDevice(1, SelectedLevel,null);
        }
    }
}
