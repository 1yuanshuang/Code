    ...
    public class HardwareClass
    {
        ...
        public static IList<HardwareInfo> GetHardwareTable(out Dictionary<Guid, HardwareInfo> ParentDic)
        {
            ...
            while (SetupDiEnumDeviceInfo(_MainIntPtr, i, _DevinfoData))
            {
                ...
                HardwareInfo hardwareInfo = new HardwareInfo(_DeviceName.ToString(), _DevinfoData.classGuid, _DevinfoData.cbSize,_DevinfoData.devInst, _DevinfoData.reserved);
        ...
        //        //  添加父节点
        //        // Console.WriteLine("父节点：" + DeviceName);
        //        _ReturnList.Add(new HardwareInfo(_DeviceName.ToString(), _DevinfoData.classGuid, _DevinfoData.cbSize, _DevinfoData.devInst, _DevinfoData.reserved));
