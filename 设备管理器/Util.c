...
//
void ListViewInsertColumnText(HWND hListView, const short wIdx,const int wFmt, char *pszText, const BOOL bFinal)
{
    LVCOLUMN   column;
    TEXTMETRIC text;
    int        nWidth;
...
//
HTREEITEM MakeDeviceRootTree(SP_CLASSIMAGELIST_DATA spImageData,const UINT nIdTree, const UINT nIdBmp)
{
