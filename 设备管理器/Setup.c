...
//
    ...
    if (GetACP() == 950)
        ListViewInsertItemText(hListView, wCnt, 0, "°O¾ÐÅé½d³ò");
    else
    ...
    if (pMemDes->MD_Count)
    {
                               ...
                               (LONG)(sizeof(MEM_DES) / pMemDes->MD_Type)); wLoop++)
        {
                ...
                (pMemRange->MR_Min < pMemRange->MR_Max))
            {
                ...
                if (GetACP() == 950)
                    ListViewInsertItemText(hListView, wCnt+wLoop+1, 0, "°O¾ÐÅé½d³ò");
                else
...
//
    if (GetACP() == 950)
        ListViewInsertItemText(hListView, wCnt, 0, "¿é¥X/¿é¤J½d³ò");
    else
    ...
    if (pIODes->IOD_Count)
    {
                            ...
                            (ULONG)(sizeof(IO_DES) / pIODes->IOD_Type)); wLoop++)
        {
                ...
                (pIORange->IOR_Min < pIORange->IOR_Max))
            {
                ...
                if (GetACP() == 950)
                    ListViewInsertItemText(hListView, wCnt+wLoop+1, 0, "¿é¥X/¿é¤J½d³ò");
                else
                    ListViewInsertItemText(hListView, wCnt, 0, "IO Range");
                ListViewInsertItemText(hListView, wCnt+wLoop+1, 1, szBuf);
            };
